...
##############################################################################
# Note: Generated by soapfish.wsdl2py at 2017-07-18 17:04:37.521652
...
class SolicitudDeFirma(xsd.ComplexType):
    ...
    @classmethod
    def create(cls, CodNegocio, FechaDeReferenciaDeLaEntidad, IDAlgoritmoHash, IdReferenciaEntidad):
        instance = cls()
...
class RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirmaResponse(xsd.ComplexType):
    INHERITANCE = None
    INDICATOR = xsd.Sequence
    RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirmaResult = xsd.Element(
...
class RecibaLaSolicitudDeFirmaODFResponse(xsd.ComplexType):
    INHERITANCE = None
    INDICATOR = xsd.Sequence
    RecibaLaSolicitudDeFirmaODFResult = xsd.Element(
        RespuestaDeLaSolicitud, minOccurs=0)
...
class RecibaLaSolicitudDeFirmaMSOfficeResponse(xsd.ComplexType):
    INHERITANCE = None
    INDICATOR = xsd.Sequence
    RecibaLaSolicitudDeFirmaMSOfficeResult = xsd.Element(
        RespuestaDeLaSolicitud, minOccurs=0)
...
Schema_c49e7 = xsd.Schema(
    ...
    attributeGroups=[],
    groups=[],
    complexTypes=[SolicitudDeFirma,
                  ExtensionDataObject, RespuestaDeLaSolicitud],
    elements={'RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirma': xsd.Element(RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirma()), 'RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirmaResponse': xsd.Element(RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirmaResponse()), 'RecibaLaSolicitudDeFirmaODF': xsd.Element(RecibaLaSolicitudDeFirmaODF()), 'RecibaLaSolicitudDeFirmaODFResponse': xsd.Element(RecibaLaSolicitudDeFirmaODFResponse()), 'RecibaLaSolicitudDeFirmaMSOffice': xsd.Element(
        RecibaLaSolicitudDeFirmaMSOffice()), 'RecibaLaSolicitudDeFirmaMSOfficeResponse': xsd.Element(RecibaLaSolicitudDeFirmaMSOfficeResponse()), 'ElSuscriptorEstaConectado': xsd.Element(ElSuscriptorEstaConectado()), 'ElSuscriptorEstaConectadoResponse': xsd.Element(ElSuscriptorEstaConectadoResponse()), 'ValideElServicio': xsd.Element(ValideElServicio()), 'ValideElServicioResponse': xsd.Element(ValideElServicioResponse())},
)
...
FirmadorSoap_SERVICE = soap.Service(
    ...
    methods=[RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirma_method, RecibaLaSolicitudDeFirmaODF_method,
             RecibaLaSolicitudDeFirmaMSOffice_method, ElSuscriptorEstaConectado_method, ValideElServicio_method],
)
