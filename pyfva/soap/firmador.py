...
##############################################################################
# Note: Generated by soapfish.wsdl2py at 2017-11-14 09:43:06.846035
...
Schema_c49e7 = xsd.Schema(
    ...
    attributeGroups=[],
    groups=[],
    complexTypes=[SolicitudDeFirma, ExtensionDataObject, RespuestaDeLaSolicitud],
...
FirmadorSoap_SERVICE = soap.Service(
    ...
    methods=[RecibaLaSolicitudDeFirmaXmlEnvelopedCoFirma_method, RecibaLaSolicitudDeFirmaXmlEnvelopedContraFirma_method, RecibaLaSolicitudDeFirmaODF_method, RecibaLaSolicitudDeFirmaMSOffice_method, ElSuscriptorEstaConectado_method, ValideElServicio_method],
)
