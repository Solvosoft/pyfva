...
##############################################################################
# Note: Generated by soapfish.wsdl2py at 2017-07-18 17:05:22.453273
...
class ResultadoDeLaSolicitud(xsd.ComplexType):
    ...
    InformacionDelCertificado = xsd.Element(
        __name__ + '.InformacionDelCertificado', minOccurs=0)
...
class SoliciteLaValidacionDeCetificadoDeAutenticacionResponse(xsd.ComplexType):
    INHERITANCE = None
    INDICATOR = xsd.Sequence
    SoliciteLaValidacionDeCetificadoDeAutenticacionResult = xsd.Element(
        ResultadoDeLaSolicitud, minOccurs=0)
...
Schema_c49e7 = xsd.Schema(
    ...
    elements={'SoliciteLaValidacionDeCetificadoDeAutenticacion': xsd.Element(SoliciteLaValidacionDeCetificadoDeAutenticacion()), 'SoliciteLaValidacionDeCetificadoDeAutenticacionResponse': xsd.Element(
        SoliciteLaValidacionDeCetificadoDeAutenticacionResponse()), 'ValideElServicio': xsd.Element(ValideElServicio()), 'ValideElServicioResponse': xsd.Element(ValideElServicioResponse())},
)
...
ValidadorDeCertificadoSoap_SERVICE = soap.Service(
    ...
    methods=[SoliciteLaValidacionDeCetificadoDeAutenticacion_method,
