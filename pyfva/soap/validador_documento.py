...
class ValideElDocumentoJsonEnvelopingCoFirma(xsd.ComplexType):
    INHERITANCE = None
    INDICATOR = xsd.Sequence
    elDocumento = xsd.Element(xsd.Base64Binary, minOccurs=0)
...
class ValideElDocumentoJsonEnvelopingCoFirmaResponse(xsd.ComplexType):
    INHERITANCE = None
    INDICATOR = xsd.Sequence
    ValideElDocumentoJsonEnvelopingCoFirmaResult = xsd.Element(ResultadoValidacion, minOccurs=0)
...
class ValideElDocumentoJsonParaArchivosFHIR(xsd.ComplexType):
    INHERITANCE = None
    INDICATOR = xsd.Sequence
    elDocumento = xsd.Element(xsd.Base64Binary, minOccurs=0)
...
class ValideElDocumentoJsonParaArchivosFHIRResponse(xsd.ComplexType):
    INHERITANCE = None
    INDICATOR = xsd.Sequence
    ValideElDocumentoJsonParaArchivosFHIRResult = xsd.Element(ResultadoValidacion, minOccurs=0)
...
ValideElDocumentoJsonEnvelopingCoFirma_method = xsd.Method(
    soapAction=settings.FVA_HOST + 'ValideElDocumentoJsonEnvelopingCoFirma',
    input='ValideElDocumentoJsonEnvelopingCoFirma',
    inputPartName='parameters',
    output='ValideElDocumentoJsonEnvelopingCoFirmaResponse',
    outputPartName='parameters',
    operationName='ValideElDocumentoJsonEnvelopingCoFirma',
    style='document',
)


ValideElDocumentoJsonParaArchivosFHIR_method = xsd.Method(
    soapAction=settings.FVA_HOST + 'ValideElDocumentoJsonParaArchivosFHIR',
    input='ValideElDocumentoJsonParaArchivosFHIR',
    inputPartName='parameters',
    output='ValideElDocumentoJsonParaArchivosFHIRResponse',
    outputPartName='parameters',
    operationName='ValideElDocumentoJsonParaArchivosFHIR',
    style='document',
)
...
ValidadorDeDocumentosSoap_SERVICE = soap.Service(
    ...
    methods=[ValideElDocumentoPdf_method, ValideElDocumentoXmlEnvelopedContraFirma_method, ValideElDocumentoXmlEnvelopedCoFirma_method, ValideElDocumentoJsonEnvelopingCoFirma_method, ValideElDocumentoJsonParaArchivosFHIR_method, ValideElDocumentoMSOffice_method, ValideElDocumentoOdf_method, ValideElServicio_method],
)
...
class ValidadorDeDocumentosSoapServiceStub(soap.Stub):
    ...
    def ValideElDocumentoJsonEnvelopingCoFirma(self, ValideElDocumentoJsonEnvelopingCoFirma, header=None):
        return self.call('ValideElDocumentoJsonEnvelopingCoFirma', ValideElDocumentoJsonEnvelopingCoFirma, header=header)

    def ValideElDocumentoJsonParaArchivosFHIR(self, ValideElDocumentoJsonParaArchivosFHIR, header=None):
        return self.call('ValideElDocumentoJsonParaArchivosFHIR', ValideElDocumentoJsonParaArchivosFHIR, header=header)
