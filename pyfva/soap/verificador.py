...
##############################################################################
# Note: Generated by soapfish.wsdl2py at 2017-07-18 17:06:25.738239
...
class ExisteUnaSolicitudDeFirmaCompletaResponse(xsd.ComplexType):
    INHERITANCE = None
    INDICATOR = xsd.Sequence
    ExisteUnaSolicitudDeFirmaCompletaResult = xsd.Element(
...
Schema_c49e7 = xsd.Schema(
    ...
    elements={'ExisteUnaSolicitudDeFirmaCompleta': xsd.Element(ExisteUnaSolicitudDeFirmaCompleta()), 'ExisteUnaSolicitudDeFirmaCompletaResponse': xsd.Element(
        ExisteUnaSolicitudDeFirmaCompletaResponse()), 'ValideElServicio': xsd.Element(ValideElServicio()), 'ValideElServicioResponse': xsd.Element(ValideElServicioResponse())},
)
...
VerificadorSoap_SERVICE = soap.Service(
    ...
    targetNamespace=settings.FVA_HOST,
    location='${scheme}://${host}/WebServices/Bccr.Firma.Fva.Entidades.Ws.BS/Verificador.asmx',
